...
public class User {
	...
	@NotBlank(message = "El name es necesario")
	@Size(min=3, max=30, message="name debe tener entre 3 y 30 caracteres")
	private String name;
	...
	public User(String name, String email,Date nacimiento, String password, String confirm) {
		this.name = name;
		this.email = email;
